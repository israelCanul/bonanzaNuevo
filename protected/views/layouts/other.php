            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="z-index:2">
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?php echo Yii::app()->request->baseUrl; ?>/#descriptions">The Tour</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?php echo Yii::app()->request->baseUrl; ?>/#galeriaEventos">Media</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?php echo Yii::app()->request->baseUrl; ?>/#textoGaleria">Events</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?php echo Yii::app()->request->baseUrl; ?>/#about_us">About Us</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?php echo Yii::app()->request->baseUrl; ?>/#contact">Contact</a></li>

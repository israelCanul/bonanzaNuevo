...
<div class="menuPrincipal row">
	...
	<div class="itemMenu col-xs-8 col-sm-9 menu" style="">
	    <nav class="navbar navbar-default">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="z-index:2;background:white;">
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="#descriptions">Tour</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="#galeriaEventos">Galería</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="#textoGaleria">Eventos</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="#about_us">Conózcanos</a></li>
				  <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="#contact">Contacto</a></li>
          ...
          <li role="presentation "><a class="opcPrincipal" data-ajax="false" href="<?=Yii::app()->request->baseUrl?>/es"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/iconos/flag-ES.png"></a></li>
                </ul>
              </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>	
